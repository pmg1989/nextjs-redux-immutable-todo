...
// EXTERNAL MODULE: ./src/containers/List.less
var containers_List = __webpack_require__(79);
var List_default = /*#__PURE__*/__webpack_require__.n(containers_List);

// CONCATENATED MODULE: ./src/containers/List.js
...
var List_List = function List() {
  ...
  return external__react__default.a.createElement(
    ...
    external__react__default.a.createElement(
      'div',
      { className: List_default.a.box },
      external__react__default.a.createElement(
        link__default.a,
        { href: { pathname: 'list-detail', query: { id: '2' } } },
        'list detail id 2'
      ),
      'STATIC_HOST: ',
      config["STATIC_HOST"],
...
/* harmony default export */ var src_containers_List = (List_List);
// CONCATENATED MODULE: ./pages/list.js



/* harmony default export */ var list = __webpack_exports__["default"] = (Object(createStore["a" /* default */])(src_containers_List));
